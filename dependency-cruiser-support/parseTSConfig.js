...
const transpilers = require('dependency-cruiser').getAvailableTranspilers()
const typescriptTranspiler = transpilers.find(x => x.name == 'typescript');
const typescript = tryRequire(
    "typescript",
    typescriptTranspiler.version
);
